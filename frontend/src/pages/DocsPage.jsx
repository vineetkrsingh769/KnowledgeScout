            ...
            <div key={doc._id} className="bg-white rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-200 overflow-hidden">
              <div className="p-6">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button
                      onClick={() => window.location.assign(`/ask?docId=${doc._id}`)}
                      title="Ask about this document"
                      className="px-2 py-1 rounded-md bg-orange-50 hover:bg-orange-100 text-orange-700 border border-orange-200 transition-colors flex items-center gap-1"
                    >
                    ...
                    <button
                      ...
                      title="Delete"
                      className="px-2 py-1 rounded-md bg-red-50 hover:bg-red-100 text-red-600 border border-red-200 transition-colors"
                    >
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
